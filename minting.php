					...
					<div id="collapseOne" class="panel-collapse collapse">
						<div class="item">
							<div class="col-lg-12">
								...
								<img src="/img/minting/minting1.png" alt="Minting" />
							</div>
						</div>
						<div class="item">
							<div class="col-lg-12">
	...
	#reservebalance=25
						...
						<div class="item">
							<div class="col-lg-12">
								...
								<img src="/img/minting/minting2.png" alt="Minting" />
							</div>
						</div>
						<div class="item">
							<div class="col-lg-12">
	...
	ppcoind walletpassphrase %variable% 9999999 true
						...
						<div class="item">
							<div class="col-lg-12">
								...
								<img src="/img/minting/minting3.png" alt="Minting" />
								<p>Now double click the minting.bat file and enter your passphrase.<br /></p>
								<img src="/img/minting/minting4.png" alt="Minting" /><br />
